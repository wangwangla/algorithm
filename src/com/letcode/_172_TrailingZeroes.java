...
public class _172_TrailingZeroes {
     ...
     * nx(n-1)x(n-2)……
     *
     * n! 尾零的数量即为 n! 中因子 10 的个数，而 10=2\times 510=2×5，
     * 因此转换成求 n!n! 中质因子 22 的个数和质因子 55 的个数的较小值。
     *
     * 由于质因子 55 的个数不会大于质因子 22 的个数（具体证明见方法二），
     *
     * 我们可以仅考虑质因子 55 的个数。
     *
     * 而 n!n! 中质因子 55 的个数等于 [1,n][1,n] 的每个数的质因子 55
     * 的个数之和，我们可以通过遍历 [1,n][1,n] 的所有 55 的倍数求出。
     * @param n
     * @return
     */
